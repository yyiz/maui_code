...
#define SRC_L 1
#define SRC_W 1
#define SRC_ORIGX 10.0
#define SRC_ORIGY 20.0
...
#define SENS_L 1
#define SENS_W 1
#define SENS_ORIGX 30.0
#define SENS_ORIGY 19.5
...
#define VOX_ORIGX 24.5
#define VOX_ORIGY 19.5
#define VOX_ORIGZ 2.0
#define VOX_L 1
#define VOX_W 1
#define VOX_H 1
#define VOX_SIDELEN 0.001
#define VOX_ZLEN 0.001
// ----------------------------------------------
...
#define NUMLAYERS 3
#define ALL_LAYERS {0, 10, 12, 30} // must be length NUMLAYERS+1; includes top and bottom of layers
#define ABS_VEC {0.05, 0.004, 0.02}
#define SCAT_VEC {9.0, 0.009, 10}
#define ANIS_VEC {0.9, 0.9, 0.9}
#define REFR_VEC {1.4, 1.4, 1.4}
