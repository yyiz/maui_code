...
#define NUM_ITERS 250 // Number of iterations: total photon samples == NUM_SAMPS*NUM_ITERS
...
#define SENS_L 19
#define SENS_W 19
#define SENS_ORIGX (-36.5)
#define SENS_ORIGY (-37.0)
...
#define VOX_ORIGX (-41.0)
#define VOX_ORIGY (-41.0)
#define VOX_ORIGZ 0.5
#define VOX_L 81
#define VOX_W 81
#define VOX_H 7
...
#define SLAB_MINX (-41.1)
#define SLAB_MAXX 40.1
#define SLAB_MINY (-41.1)
#define SLAB_MAXY 40.1
...
#define REFR_VEC {1.0} // Refractive index for each layer, n=1.0 used here since IRF calibrated to background TPSF
