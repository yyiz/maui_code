...
#define NUM_ITERS 2000 // Number of iterations: total photon samples == NUM_SAMPS*NUM_ITERS
...
#define SENS_L 5
#define SENS_W 5
#define SENS_ORIGX (-3.5)
#define SENS_ORIGY (-3.5)
...
#define VOX_ORIGX (-16.0)
#define VOX_ORIGY (-16.0)
#define VOX_ORIGZ 5.5
#define VOX_L 128
#define VOX_W 128
#define VOX_H 6
#define VOX_SIDELEN 0.25
#define VOX_ZLEN 1.0
// ----------------------------------------------
...
#define ALL_LAYERS {0, 12.01} // Boundaries of each slab layer. Note: slab i is lower and upper bounded by ALL_LAYERS[i], ALL_LAYERS[i+1], respectively
